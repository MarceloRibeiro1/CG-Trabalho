...
initDefaultSpotlight(scene, new THREE.Vector3(2000, 4000, 2000)); // Use default light

var renderer = initRenderer();    // View function in util/utils
  renderer.setClearColor("rgb(30, 30, 42)");
var camera = new THREE.PerspectiveCamera(45, window.innerWidth / window.innerHeight, 0.01, 10000);
  camera.lookAt(0, 0, 0);
  camera.position.set(200.8, 100.8, 400.0);
  camera.up.set( 0, 1, 0 );
...
// Load animated files
loadGLTFFile('../works/pile_of_tires/','scene.gltf', false);
